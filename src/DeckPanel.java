...
class DeckPanel extends JPanel {
    ...
    DeckPanel(Deck deck, int left, int top, int width, int height, int gap)
    {

        int numCards = deck.cards.size();
        ...
        {
            ImagePanel cardImagePanel = new ImagePanel(deck.cards.get(i).getFileName());
